...
animalNames(zooAnimals);
  ...
  */
  ...
  function lowerCaseNames(animals){
    return animals.map(match => match.animal_name.toLowerCase());
  }
  ...
  */
  ...
  function lowPopulationAnimals(animals){
    return animals.filter(match => match.population < 5);
  }
 ...
 function USApop(animals){
  ...
  function animalPopulation()
   {
     return animals.map(match => match.population);
   }

   const populationTotal = function(accumulator,num)
   {
     return accumulator + num;

   }
   
   const population = animalPopulation();
   return population.reduce(populationTotal,0);
 }
